...
const App = () => {
  const extUrl = "http://localhost:5173/public/prospect-vault-ext.zip";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-2 sm:p-4">
      <div className="max-w-6xl w-full bg-white rounded-lg shadow-lg p-4 sm:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 min-h-[400px] md:h-[600px] max-w-6xl">
          {/* Carousel Section */}
          ...
          <div className="flex flex-col h-full">
            <div className="flex-grow space-y-4 md:space-y-6">
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <ol className="list-decimal list-inside space-y-1 md:space-y-2 text-gray-700 text-sm md:text-base">
